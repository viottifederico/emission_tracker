...
#st.sidebar.markdown("# Proj_1")

df = pd.read_csv("./data_processed/single_project/logisticregressionmodel_wildcard_df.csv")
series = pd.read_csv("./data_processed/single_project/logisticregressionmodel_series_df.csv")
