...
#st.sidebar.markdown("# Proj_3")

df = pd.read_csv("./data_processed/single_project/xgboostmodel_wildcard_df.csv")
series = pd.read_csv("./data_processed/single_project/xgboostmodel_series_df.csv")
