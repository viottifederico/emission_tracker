...
df = pd.read_csv("./data_processed/whole_project/grouped_all_wildcard_df.csv")
series = pd.read_csv("./data_processed/whole_project/grouped_all_series_df.csv")
...
st.scatter_chart(series, x=series['duration'],y=series['emissions'])
